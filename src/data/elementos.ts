...
export const ELEMENTOS = {
  ...
  victima: { nombre: 'Víctima', posicion: posicion(-22, -20.5), dimensiones: [0.65, 0.3, 1.8], color: '#e3aa72' },
  camilla: { nombre: 'Camilla bote', posicion: posicion(-22, 11), dimensiones: [1, 0.25, 2.3], color: '#dc8150' },
  herramientas: { nombre: 'Holligan / TNT', posicion: posicion(-3.5, -3), dimensiones: [2, 0.2, 1.3], color: '#b9c6c0' },
  escala: { nombre: 'Escala · 6 m', posicion: posicion(12, -20), alto: 6, anchoVisual: 0.9 },
  material: { nombre: 'Zona material', posicion: posicion(8.5, 28.5), ancho: 10, largo: 6 },
  inicio: { nombre: 'Zona inicio', posicion: posicion(19.5, 28.5), ancho: 9, largo: 6 },
}
