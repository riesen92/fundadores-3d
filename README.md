...
En `/simulador`, **Vista general** conserva el encuadre completo desde arriba en cenital. Elegir Bombero 1–8 acerca la cámara y mantiene al bombero seleccionado centrado mientras se mueve, sin impedir orbitar o acercar; en cenital el seguimiento conserva la orientación cenital (C arriba, A abajo). El botón principal cambia entre Simular, Pausar, Continuar y Repetir. **Reiniciar** vuelve el tiempo, los bomberos, los materiales y los blancos al inicio y reproduce de nuevo, conservando la velocidad, la vista y el bombero elegido. El selector de **velocidad** (0,25×, 0,5×, 1×, 2×, 4×) arranca en 1× y puede cambiarse antes, durante o en pausa; no se restablece al Simular o Continuar. El botón **ⓘ Información de la cancha** de la cabecera abre un panel lateral con zonas, medidas, reglas y los mismos controles visuales del editor (etiquetas, nombres, recorridos, cierres); se cierra con el botón X/Cerrar o Escape y no pausa ni altera la cámara. Los recorridos de bomberos arrancan desactivados y en Vista general no se muestran: elige B1–B8 para verlos. Esta vista usa la misma estrategia y los mismos nombres guardados en `/editor`.
